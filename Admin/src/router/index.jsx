    ...
    children: [
      {
        ...
        children: [
          ...
          { path: 'promotions/discounts',       element: <ComingSoonPage title="Chương trình khuyến mãi" /> },
          { path: 'promotions/gifts',           element: <ComingSoonPage title="Chương trình tặng kèm" /> },
